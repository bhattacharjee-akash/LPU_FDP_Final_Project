  ...
  useEffect(() => {
    async function loadSettingsAndProfile() {
      try {
        ...
        const loadedProvider = settingsRes.llm_provider || 'gemini';
        setProvider(loadedProvider);
        
        let loadedModel = settingsRes.model_name || 'gemini-3.1-flash-lite';
        if (loadedProvider === 'gemini') {
          loadedModel = 'gemini-3.1-flash-lite';
